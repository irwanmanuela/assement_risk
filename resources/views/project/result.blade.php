                ...
                <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                    ...
                    <div class="gallery">
                        ...
                        <!--
                          ...
                          -->
                        <div class="gallery-item first" data-width="1" data-height="2">
                            <!-- START PREVIEW -->
                            ...
                            <div class="overlayer bottom-left full-width">
                                <div class="overlayer-wrapper item-info ">
                                    <div class="gradient-grey p-l-20 p-r-20 p-t-20 p-b-5">
                                        <div class="">
                                            <p class="pull-left bold text-white fs-14 p-t-10">Project 1</p>
                        ...
                        <div class="gallery-item " data-width="2" data-height="2">
                            ...
                            <div class="overlayer bottom-left full-width">
                                <div class="overlayer-wrapper item-info more-content">
                                    <div class="gradient-grey p-l-20 p-r-20 p-t-20 p-b-5">
                                        <div class="">
                                            <h3 class="pull-left bold text-white no-margin">Project 2</h3>
                        ...
                        <div class="gallery-item " data-width="1" data-height="1">
                            ...
                            <div class="overlayer bottom-left full-width">
                                <div class="overlayer-wrapper item-info ">
                                    <div class="gradient-grey p-l-20 p-r-20 p-t-20 p-b-5">
                                        <div class="">
                                            <p class="pull-left bold text-white fs-14 p-t-10">Project 3</p>
                                            <h5 class="pull-right semi-bold text-white font-montserrat bold">$25.00</h5>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="m-t-10">
                        ...
                        <div class="gallery-item " data-width="1" data-height="1">
                            ...
                            <div class="overlayer bottom-left full-width">
                                <div class="overlayer-wrapper item-info ">
                                    <div class="gradient-grey p-l-20 p-r-20 p-t-20 p-b-5">
                                        <div class="">
                                            <p class="pull-left bold text-white fs-14 p-t-10">Project 4</p>
                                            <h5 class="pull-right semi-bold text-white font-montserrat bold">$25.00</h5>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="m-t-10">
