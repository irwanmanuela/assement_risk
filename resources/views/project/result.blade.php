...
@section('content')
            ...
            <div class="container-fluid">
                <div class="row dialog__overview" style=" max-height: calc(100vh - 210px); overflow-y: auto;">
                    ...
                    <div class="col-sm-7 p-r-35 p-t-35 p-l-35 full-height item-description">
                        ...
                        @endforeach
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Antara</h5>
                        @foreach($data_antara_match[0][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                        ...
                        @endforeach
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Draft Akhir</h5>
                        @foreach($data_draft_akhir_match[0][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                        ...
                        @endforeach
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Akhir</h5>
                        @foreach($data_akhir_match[0][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
        ...
        <div class="dialog__content">
            <div class="container-fluid">
                <div class="row dialog__overview" style=" max-height: calc(100vh - 210px); overflow-y: auto;">
                    <div class="col-sm-5 no-padding item-slideshow-wrapper full-height">
                        <div class="item-slideshow full-height">
                            <div class="slide"  data-image="{{asset('assets/img/dashboard/pages_hero.jpg')}}"></div>
                        </div>
                    </div>
                    <div class="col-sm-7 p-r-35 p-t-35 p-l-35 full-height item-description">

                        <h2 class="semi-bold no-margin font-montserrat">{{ $data_project_match[1][0]->name }}</h2>
                        <p class=" pull-left">Category {{ $data_project_match[1][0]->type_project }}</p>
                        <br>
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Pendahuluan</h5>
                        @foreach($data_pendahuluan_match[1][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                        ...
                        @endforeach
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Antara</h5>
                        @foreach($data_antara_match[1][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                        ...
                        @endforeach
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Draft Akhir</h5>
                        @foreach($data_draft_akhir_match[1][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                        ...
                        @endforeach
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Akhir</h5>
                        @foreach($data_akhir_match[1][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                ...
                <div class="row dialog__footer bg-info-dark hidden-xs">
                    <div class="col-sm-7 full-height separator">
                        <div class="row-xs-height">
                            ...
                            <div class="col-xs-5 col-xs-height col-middle text-right  no-padding">
                                <h2 class="bold text-white price font-montserrat">{{ $data_matching[1]->persentase }} %</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-5 full-height">
    ...
    <div id="itemDetails3" class="dialog item-details">
        <div class="dialog__overlay"></div>
        <div class="dialog__content">
            <div class="container-fluid">
                <div class="row dialog__overview" style=" max-height: calc(100vh - 210px); overflow-y: auto;">
                    <div class="col-sm-5 no-padding item-slideshow-wrapper full-height">
                        <div class="item-slideshow full-height">
                            <div class="slide"  data-image="{{asset('assets/img/dashboard/image4.jpg')}}"></div>
                        </div>
                    </div>
                    <div class="col-sm-7 p-r-35 p-t-35 p-l-35 full-height item-description">

                        <h2 class="semi-bold no-margin font-montserrat">{{ $data_project_match[2][0]->name }}</h2>
                        <p class=" pull-left">Category {{ $data_project_match[2][0]->type_project }}</p>
                        <br>
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Pendahuluan</h5>
                        @foreach($data_pendahuluan_match[2][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                        ...
                        @endforeach
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Antara</h5>
                        @foreach($data_antara_match[2][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                        ...
                        @endforeach
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Draft Akhir</h5>
                        @foreach($data_draft_akhir_match[2][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                        ...
                        @endforeach
                        <h5 class="semi-bold no-margin font-montserrat">Laporan Akhir</h5>
                        @foreach($data_akhir_match[2][0] as $data)
                            <li>
                                {{ $data->activity_name }}
                            </li>
                            <p class="fs-13 m-l-20">{{ $data->activity_desc }}</p>
                ...
                <div class="row dialog__footer bg-info-dark hidden-xs">
                    <div class="col-sm-7 full-height separator">
                        <div class="row-xs-height">
                            ...
                            <div class="col-xs-5 col-xs-height col-middle text-right  no-padding">
                                <h2 class="bold text-white price font-montserrat">{{ $data_matching[2]->persentase }} %</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-5 full-height">
