            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        {{--<select class="js-example-basic-multiplea full-width select2 choosen" id=""  name="item_akhir[]" data-placeholder="-- Pilih --" data-init-plugin="select2">--}}
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        <input type="text" class="form-control order" data-error="wajib diisi" id="order" placeholder="0 Month" required name="duration_akhir[]" aria-required="true" value="">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <input type="text" class="form-control order" data-error="wajib diisi" id="order" placeholder="Rp. 0,-" required name="pinalti_akhir[]" aria-required="true" value="">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-sm-1">
